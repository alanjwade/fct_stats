...
def main():
    ...
    # Find the ODS file
    ods_path = Path(__file__).parent.parent / 'data' / 'sources' / '2025' / '2025 Track & Field Performance List 3.xlsx.ods'
    ...
    # Save to JSON
    output_path = Path(__file__).parent.parent / 'data' / 'snapshots' / '2025' / 'parsed_performance_list.json'
